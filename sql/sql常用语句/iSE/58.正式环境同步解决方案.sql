...
/****** Object:  StoredProcedure [dbo].[P_SyncSolProductInfo]    Script Date: 2020-12-25 16:29:08 ******/
SET ANSI_NULLS ON
GO
	...
	begin
		...
		begin try
			begin transaction 
				...
				--导入R版本
				MERGE Sol_DataIDSet  AS T
				USING (SELECT pro.Release_Code,pro.Release_Name,pro.Solution_Code FROM Sol_ProductInfo pro GROUP BY pro.Release_Code,pro.Release_Name,pro.PDT_Code)  AS S
