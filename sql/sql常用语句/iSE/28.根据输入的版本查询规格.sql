with  curblids as(select sl.blID as blID 
		                          FROM specMS_SpecList sl
		                          where   verTreeCode  in ('PB002139','PB000936','PR002876','PR002455','PB000933','PB004122','PB000937','PB000935','PB003563','PR003544','PB003035','PB000934' )  
		                          union select moduleRel.blID
		                          from specMS_SpecModule module 
		                          inner join specMS_SpecModuleBLRel moduleRel on module.smID = moduleRel.smID
		                          where module.verTreeCode in ('PB002139','PB000936','PR002876','PR002455','PB000933','PB004122','PB000937','PB000935','PB003563','PR003544','PB003035','PB000934' ) ) ,blps as (select blID from specMS_SpecBaseLine where blID in( select specMS_TabRefBaseLine.blID from 
	                                                    ...
	                                                    and  specMS_SpecList.verTreeCode in ('PB002139','PB000936','PR002876','PR002455','PB000933','PB004122','PB000937','PB000935','PB003563','PR003544','PB003035','PB000934' ) 
                                                        union  
                                                        select moduleRel.blID
                                                        from specMS_SpecModule module,specMS_SpecModuleBLRel moduleRel
                                                        where module.smID = moduleRel.smID and module.verTreeCode in ('PB002139','PB000936','PR002876','PR002455','PB000933','PB004122','PB000937','PB000935','PB003563','PR003544','PB003035','PB000934' ) )  and status=1),blids as (select * from blps ) ,
	bls as(
