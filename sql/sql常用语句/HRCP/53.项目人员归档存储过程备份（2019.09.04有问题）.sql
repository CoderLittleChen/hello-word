...
/****** Object:  StoredProcedure [dbo].[P_ArchiveProjectPersonInfo]    Script Date: 2019/9/4 9:38:42 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROC [dbo].[P_ArchiveProjectPersonInfo]
    @ProPersonId UNIQUEIDENTIFIER,
    @coomgr VARCHAR(50),
    @Modifier VARCHAR(50)
AS
BEGIN
    ...
    SELECT NEWID(),
           ...
           Person,
           MaterialLeaveFileNo,
		   (select   top  1  ProjectPersonRecordId  from   ProjectPersonRecord_History  a  where  a.ProjectPersonInfoId=@ProPersonId  order  by  a.ModificationDate desc)
    FROM MaterialFile
