...
/****** Object:  UserDefinedFunction [dbo].[F_GetUserDayPercentsHistory]    Script Date: 2020/2/4 16:51:32 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	--判断当前日期是否为工作日
	select  @isWorkDay=IsWorkingDay  from  DateSetting  a  where  a.Date=@date;
