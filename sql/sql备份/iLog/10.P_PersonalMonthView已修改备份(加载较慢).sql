...
/****** Object:  StoredProcedure [dbo].[P_PersonalMonthView]    Script Date: 2019/12/17 15:14:10 ******/
SET ANSI_NULLS ON
GO
...
AS
	...
	(
        ...
        FROM    dbo.DateSetting a
                LEFT JOIN ( SELECT  hm.BillNo ,
                            ...
                            FROM    dbo.HourInfoMain hm
                                    ...
                                    LEFT JOIN ProductInfo_Display p ON ( ( hi.ProID = p.ProductLineID
                                                              AND p.PDTID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.PDTID
                                                              AND p.FirstProID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.FirstProID
                                                              AND SecondProID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.SecondProID
                                                              AND p.ThirdProID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.ThirdProID
                                                              AND p.FourthProID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.FourthProID
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              )
        ...
        FROM    dbo.DateSetting a  
                LEFT JOIN ( SELECT  hm.BillNo ,
                            ...
                            FROM    dbo.HourInfoMain hm
                                    INNER JOIN dbo.HourInfo_New hi ON hi.HMain_ID = hm.id
                                    LEFT JOIN ProductInfo_Display p ON 
														( 
														      ( hi.ProID = p.ProductLineID
                                                              AND p.PDTID = '00000000-0000-0000-0000-000000000000'
                                                              AND hi.ProID != '00000000-0000-0000-0000-000000000000'
                                                              )
                                                              OR ( hi.ProID = p.PDTID
	...
	SELECT  ISNULL(b.ProductLineID, '00000000-0000-0000-0000-000000000000') ProductLineID ,
        ...
        IF ( CHARINDEX('5', @conditionFlag) > 0 )
            BEGIN
                SET @conWhere = ' Where (FillState=''未填写''';
            END; 
