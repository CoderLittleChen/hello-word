...
/****** Object:  View [dbo].[V_Flow]    Script Date: 2019/12/3 18:06:07 ******/
SET ANSI_NULLS ON
GO
...
UNION  ALL
--------------------------------------------------------实习生需求申请--------------
SELECT  ('[HRCP]'+'实习生需求申请') AS  [SUBJECT],
dbo.F_GetRegionAccountByUserInfo(req.CreateBy,'region') AS   ADDUSERID,
dbo.F_GetRegionAccountByUserInfo(req.CreateBy,'name')  AS  ADDUSERNAME,
(CONVERT(varchar(50),req.CreateTime,20)) AS  APPLYTIME,  
dbo.F_GetRegionAccountByUserInfo(pf.CurrentPerson,'region')  AS  AUTHORID,
...
dbo.F_GetRegionAccountByCNName(pe.EmployeeName) AS   ADDUSERID,
pe.EmployeeName  AS  ADDUSERNAME,
...
dbo.F_GetRegionAccountByCNName(personInfo.EmployeeName) AS   ADDUSERID,
personInfo.EmployeeName  AS  ADDUSERNAME,
...
dbo.F_GetRegionAccountByCNName(ppi.Name) AS   ADDUSERID,
ppi.Name  AS  ADDUSERNAME,
...
dbo.F_GetRegionAccountByUserInfo(ppi.Name,'region') AS   ADDUSERID,
ppi.Name  AS  ADDUSERNAME,
(CONVERT(varchar(50),ppe.CreateDate,20)) AS  APPLYTIME,  
dbo.F_GetRegionAccountByUserInfo(pf.CurrentPerson,'region')  AS  AUTHORID,
dbo.F_GetRegionAccountByUserInfo(pf.CurrentPerson,'name') AS  AUTHORNAME,
