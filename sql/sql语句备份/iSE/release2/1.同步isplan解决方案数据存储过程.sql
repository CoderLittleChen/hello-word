...
/****** Object:  StoredProcedure [dbo].[P_SyncSolProductInfo]    Script Date: 2020-12-24 16:23:56 ******/
SET ANSI_NULLS ON
GO
	...
	begin
		...
		begin try
			begin transaction 
				...
				WHEN NOT MATCHED THEN 
					INSERT ([SrcID],[SrcPID],[SrcName],[IDLevel],[OrderNo],[Status],[DeleteFlag],[Show]) 
					VALUES(S.Release_Code,S.PDT_Code,S.Release_Name,3,0,1,0,1);
				...
				WHEN NOT MATCHED THEN 
					INSERT ([SrcID],[SrcPID],[SrcName],[IDLevel],[OrderNo],[Status],[DeleteFlag],[Show]) 
					VALUES(S.B_Code,S.Release_Code,S.B_Name,4,0,1,0,1);
				...
				WHEN NOT MATCHED THEN 
					INSERT ([SrcID],[SrcPID],[SrcName],[IDLevel],[OrderNo],[Status],[DeleteFlag],[Show]) 
					VALUES(S.D_Code,S.B_Code,S.D_Name,5,0,1,0,1);
