...
/****** Object:  UserDefinedFunction [dbo].[F_GetSerialProjectLeaveFileCode]    Script Date: 2019/8/29 14:45:00 ******/
SET ANSI_NULLS ON
GO
...
--convert(varchar(4),mf.CreateDate,112)=convert(varchar(4),Getdate(),112) AND
