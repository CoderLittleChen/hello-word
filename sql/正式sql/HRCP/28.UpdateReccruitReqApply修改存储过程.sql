...
/****** Object:  StoredProcedure [dbo].[UpdateReqcruitReqApply]    Script Date: 2019/9/24 17:24:37 ******/
SET ANSI_NULLS ON
GO
...
OtherReason=@otherreason,Dept2MgrCc=@deptcc,CooMgrCc=@coocc,CadreCc=@cadrecc,ReceiptCc=@receiptcc,RecruitReqApplyAttach=@recruitReqApplyAttach,ModificationDate=@modificationDate,
Modifier=@modifier
