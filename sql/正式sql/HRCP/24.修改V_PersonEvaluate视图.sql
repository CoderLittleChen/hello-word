...
/****** Object:  View [dbo].[V_PersonEvaluate]    Script Date: 2019/9/12 17:43:40 ******/
SET ANSI_NULLS ON
GO
...
dept.Name AS Dept2Name,d1.Name AS DeptLevel1Name,d3.Name AS Dept3Name,d4.Name AS DeptLevel4Name,pinfo.IDCard,pinfo.CurrentLevel
