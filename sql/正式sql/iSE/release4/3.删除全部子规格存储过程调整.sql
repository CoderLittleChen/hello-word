...
/****** Object:  StoredProcedure [dbo].[P_UpdateParentEntryWhenDelete]    Script Date: 2021-01-07 14:59:15 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	if @blId=0
		begin
			...
			where not exists
			(
				select 1  from  specMS_SpecBLEntryRel  a  where  a.entryPID=temp.entryId and a.blID=@subBlId  	and a.flag=0
