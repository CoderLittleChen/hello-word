...
/****** Object:  StoredProcedure [dbo].[P_SolUpgradeOrDemoteEntry]    Script Date: 2021/1/28 14:52:55 ******/
SET ANSI_NULLS ON
GO
...
ALTER procedure  [dbo].[P_SolUpgradeOrDemoteEntry]
(
	--702|697|0,705|697|0
	--702 当前规格id
	--697 当前规格父id
...
begin
	...
	(
		...
		where  Sol_Entry.Status=0
		union all
		select  sol.EntryID  from  Sol_Entry  sol  inner join temp  on  temp.EntryID=sol.EntryPID  and sol.DeleteFlag=0  and sol.Status in(0)
	)
